...
description: "Use this agent when building enterprise Spring Boot 3+ applications requiring monolith and microservices architecture, cloud-native deployment, or reactive programming patterns."
